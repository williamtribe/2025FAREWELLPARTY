        ...
        {!generatedIntro ? (
            ...
            <div className="response-summary">
              {cards.map((card) => (
                <div key={card.num} className="response-item">
                  ...
                  <span
                    className={`response-value ${responses[card.num] === 1 ? "positive" : "negative"}`}
                  >
                    {responses[card.num] === 1
                      ? card.rightLabel
                      : card.leftLabel}
                  </span>
                </div>
          ...
          <section className="panel">
            ...
            <div className="generated-result">
              ...
              {Array.isArray(generatedIntro.interests) &&
                generatedIntro.interests.length > 0 && (
                  <div className="result-item">
                    <label>관심사</label>
                    <div className="chips">
                      {generatedIntro.interests.map((chip, idx) => (
                        <span key={`interest-${idx}`} className="chip">
                          {String(chip)}
                        </span>
                      ))}
                    </div>
              ...
              {Array.isArray(generatedIntro.strengths) &&
                generatedIntro.strengths.length > 0 && (
                  <div className="result-item">
                    <label>강점</label>
                    <div className="chips">
                      {generatedIntro.strengths.map((chip, idx) => (
                        <span key={`strength-${idx}`} className="chip">
                          {String(chip)}
                        </span>
                      ))}
                    </div>
  ...
  return (
    <div className="page ai-intro-page swipe-mode">
      ...
      <div className="swipe-stage">
        <span className="swipe-side-label left">
        ...
        <span className="swipe-side-label right">
